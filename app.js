// Firebase v10.12.2 - Final Secure Initialization (Minimal Change)
...
// --- App Initialization wrapped in an async function ---
async function main() {
    try {
        ...
        // Now that Firebase is ready, attach the main logic to DOMContentLoaded
        document.addEventListener('DOMContentLoaded', initializeUIAndEventListeners);

    } catch (error) {
        console.error("Critical Error: Firebase initialization failed.", error);
        // We can't use showMessage yet, so we use a simple alert as a fallback
...
function initializeUIAndEventListeners() {
    console.log('DOM loaded and Firebase is ready. Initializing UI...');
