...
const translations = {
  ja: {
    ...
    saveConsultationText: 'この相談内容を今後の参考のために保存する',
    clearChatText: 'チャットをクリア',
    sendButtonText: '送信',
    historyTitle: '相談履歴',
  ...
  en: {
    ...
    chatInputPlaceholder: 'Please enter your question...',
    saveConsultationText: 'Save this consultation for future reference',
